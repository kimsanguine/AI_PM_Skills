...
```bash
/plugin marketplace add kimsanguine/hplan
/plugin install oracle@kimsanguine-hplan   # 또는 atlas, forge, argus, muse
```
...
claude --plugin-dir ./hplan-repo/oracle   # 필요한 것만 선택
```
...
| **AI_PM_Skills** | 바로 설치해서 쓸 수 있는 에이전트 스킬셋 *(이 레포)* | [github.com/kimsanguine/hplan](https://github.com/kimsanguine/hplan) |
