---
name: agent-opportunity-tree
description: "Build an Agent Opportunity Tree to structure AI agent discovery — map a desired automation outcome to solvable opportunities, agent solution candidates, and validation experiments. Use when deciding WHICH agent to build, prioritizing agent ideas, or exploring the problem space before committing to implementation."
---
